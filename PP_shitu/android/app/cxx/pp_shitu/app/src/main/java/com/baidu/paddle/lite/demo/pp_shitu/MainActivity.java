...
//        mImage_settings = (ImageView) findViewById(R.id.settings);


        mImage_add_query.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mImage_take_query.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (requestAllPermissions()) {
                    label_name.setVisibility(View.INVISIBLE);
        ...
        mImage_add_gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (requestAllPermissions()) {
                    label_name.setVisibility(View.INVISIBLE);
        ...
        mImage_take_gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (requestAllPermissions()) {
                    label_name.setVisibility(View.INVISIBLE);
        ...
        mImage_save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (requestAllPermissions()) {
                    label_name.setVisibility(View.INVISIBLE);
        ...
        mShow_index.setOnClickListener(new View.OnClickListener() {
            @Override
...
//    public static String getFileContent_unique(String filePath) {
//        StringBuilder content = new StringBuilder();
//        File file = new File(filePath);
//        try {
//            InputStream inputStream = new FileInputStream(file);
...
//            while ((line = bufferedReader.readLine()) != null) {
//                String class_item = line.split(" ")[1].trim();
//                set.add(class_item);
//            }
//            content.append("共" + Integer.toString(set.size()) + "类" + "\n");
//            content.append("=========================" + "\n");
//            for (String t : set) {
...
//    }
    ...
    public void onRunModelSuccessed() {
        ...
        if (res.contains(",")) {
            ...
            tvIndexName.setText("检索库名称：" + indexPath.split("/")[0]);
        }
    }
    ...
    public void onAddGallery(Bitmap image) {
        if (image != null && predictor.isLoaded()) {
            ...
            cancel_botton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    label_name.setVisibility(View.INVISIBLE);
                    label_botton.setVisibility(View.INVISIBLE);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.help:
                if (requestAllPermissions()) {
                    ...
                    String help_content = "【功能说明】\n本 APP 基于 PaddleClas 图像分类开发套件中的通用图像识别系统 PP-ShiTu 开发，支持对拍照/本地上传的图片进行识别。\n【默认检索库说明】\n · 默认内置检索库名为：xx，主要包含常见饮料类别共计 xx 种，可通过 [类别查询] 查看已有类别信息。\n" +
                            " · 可根据实际需求，通过拍照/上传本地图像补充检索库，以提高识别准确率或增加可识别类别。\n注意：修改检索库后需进行保存，否则重启 APP 后将重置为默认态。\n";
    ...
    private void saveIndex() {
        ...
        label_botton.setVisibility(View.VISIBLE);
        cancel_botton.setVisibility(View.VISIBLE);
        label_name.setHint("save file name");
