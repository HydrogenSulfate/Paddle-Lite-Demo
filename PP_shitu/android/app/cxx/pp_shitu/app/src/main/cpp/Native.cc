...
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativeInit(
        ...
        jstring jLabelPath, jstring jIndexPath, jlongArray jDetInputShape, jlongArray jRecInputShape,
        jint cpuThreadNum, jint WarmUp, jint Repeats, jint topk, jboolean jaddGallery, jstring cpu_power)
{
    ...
    return reinterpret_cast<jlong>(new PipeLine(
            det_model_path, rec_model_path, label_path, index_path, det_input_shape_int,
            rec_input_shape_int, cpuThreadNum, WarmUp, Repeats, topk, add_gallery, cpu_mode));
}
...
JNIEXPORT jboolean JNICALL
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativesetAddGallery(JNIEnv *env, jclass thiz, jlong ctx, jboolean flag)
{
    if (ctx == 0)
    {
        return JNI_FALSE;
...
JNIEXPORT jboolean JNICALL
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativeclearGallery(JNIEnv *env, jclass thiz, jlong ctx)
{
    if (ctx == 0)
    {
        return JNI_FALSE;
...
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativeProcess(
        JNIEnv *env, jclass thiz, jlong ctx, jobject jARGB8888ImageBitmap, jstring jlabel_name)
{
    if (ctx == 0)
    {
        return JNI_FALSE;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativesaveIndex(JNIEnv *env, jclass clazz, jlong ctx, jstring jsave_file_name)
{
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativeloadIndex(JNIEnv *env, jclass clazz, jlong ctx, jstring jload_file_name)
{
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_baidu_paddle_lite_demo_pp_1shitu_Native_nativegetClassname(JNIEnv *env, jclass clazz, jlong ctx)
{
