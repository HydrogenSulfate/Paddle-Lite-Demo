...
shutil.copyfile("__init__.py", "../__init__.py")
shutil.copyfile("loader.py", "../loader.py")
...
if found_swigfaiss_generic:
    ...
    shutil.copyfile("swigfaiss.py", "../swigfaiss.py")
    shutil.copyfile(swigfaiss_generic_lib, f"../_swigfaiss{ext}")

if found_swigfaiss_avx2:
    print(f"Copying {swigfaiss_avx2_lib}")
    shutil.copyfile("swigfaiss_avx2.py", "../swigfaiss_avx2.py")
    shutil.copyfile(swigfaiss_avx2_lib, f"../_swigfaiss_avx2{ext}")
